    ...
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <p>
          ...
          space or are looking to explore the exciting career opportunities. We
          currently have over <strong>400 members</strong> from across the world
          all with various degrees of experience (
          <em>from students, early career professionals to managers!</em>) We
        ...
        <p>
          ...
          This resource can be of your choosing or you can send us funds
          directly to purchase courses/resources for the folks that need it
       ...
       <p> <h3>
        ...
        <p>
          ...
          <a href="https://instagram.com/ladiesindevops">Instagram</a> and{" "}
          <a href="https://www.linkedin.com/company/ladies-in-devops/">
            LinkedIn
          </a>{" "}
          - spreading the word and sharing our posts is a good way to reach
          people who may not even know of the exciting career opportunities that
          are available in the DevOps space. Sharing will help us a lot!
        </p>

        <p>
          Interested in supporting us?{" "}
          <a href="mailto:pauline@paulinenarvas.com">Let's talk!</a> 😊
        </p>
